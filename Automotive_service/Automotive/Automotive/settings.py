...
ALLOWED_HOSTS = [
    ...
    "automart-backend-production.up.railway.app", # Add your specific domain here
    "localhost", 
    "127.0.0.1"
]
...
#DEFAULT_FROM_EMAIL = 'AutoMart <your-email@gmail.com>'

# Note: If you just want to test without sending real emails, use the console backend:
